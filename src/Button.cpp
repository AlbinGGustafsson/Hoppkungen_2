...
Button::Button(int x, int y, int w, int h, std::string txt): EventSprite(x, y, w, h)
{
    ...
    //buttonTextures
    buttonUpTexture = IMG_LoadTexture(sys.getRenderer(), (constants::gResPath + "images/UppKnapp.png").c_str());
    buttonDownTexture = IMG_LoadTexture(sys.getRenderer(), (constants::gResPath + "images/NerKnapp.png").c_str());
}
